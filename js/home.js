...
let tests=JSON.parse(localStorage.getItem("tests"))||[
    ...
    {id:1, testName:"Thách thức sự hiểu biết của bạn4bbbb", categoryId:1, image:"/assets/images/quiz web design/Container/image 1.png", playTime:15, playAmount:2, questions:[]},
    ...
    {id:1, testName:"Thách thức sự hiểu biết của bạnbbbb", categoryId:1, image:"/assets/images/quiz web design/Container/image 1.png", playTime:15, playAmount:6, questions:[]},
    {id:1, testName:"Thách thức sự hiểu biết của bạnbbbb", categoryId:1, image:"/assets/images/quiz web design/Container/image 1.png", playTime:15, playAmount:4, questions:[]},
    {id:1, testName:"Thách thức sự hiểu biết của bạnbbbb", categoryId:1, image:"/assets/images/quiz web design/Container/image 1.png", playTime:15, playAmount:8, questions:[]},
    ...
    {id:1, testName:"Thách thức sự hiểu biết của bạnbbbb", categoryId:1, image:"/assets/images/quiz web design/Container/image 1.png", playTime:15, playAmount:10, questions:[]},
    {id:1, testName:"Thách thức sự hiểu biết của bạnbbbb", categoryId:1, image:"/assets/images/quiz web design/Container/image 1.png", playTime:15, playAmount:5, questions:[]},
    {id:1, testName:"Thách thức sự hiểu biết của bạnbbbb", categoryId:1, image:"/assets/images/quiz web design/Container/image 1.png", playTime:15, playAmount:5, questions:[]},
    {id:1, testName:"Thách thức sự hiểu biết của bạnbbbb", categoryId:1, image:"/assets/images/quiz web design/Container/image 1.png", playTime:15, playAmount:5, questions:[]},
    {id:1, testName:"Thách thức sự hiểu biết của bạnbbbb", categoryId:1, image:"/assets/images/quiz web design/Container/image 1.png", playTime:15, playAmount:5, questions:[]},
