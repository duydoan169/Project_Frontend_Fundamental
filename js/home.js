...
let tests=JSON.parse(localStorage.getItem("tests"))||[
    ...
    {id:1, testName:"Thách thức sự hiểu biết của bạn", categoryId:1, image:"/assets/images/quiz web design/Container/image 1.png", playTime:15, playAmount:8, questions:[]},
    {id:1, testName:"Thách thức sự hiểu biết của bạn", categoryId:1, image:"/assets/images/quiz web design/Container/image 1.png", playTime:15, playAmount:3, questions:[]},
    {id:1, testName:"Thách thức sự hiểu biết của bạn", categoryId:1, image:"/assets/images/quiz web design/Container/image 1.png", playTime:15, playAmount:10, questions:[]},
    {id:1, testName:"Thách thức sự hiểu biết của bạn", categoryId:1, image:"/assets/images/quiz web design/Container/image 1.png", playTime:15, playAmount:5, questions:[]},
    {id:1, testName:"Thách thức sự hiểu biết của bạn", categoryId:1, image:"/assets/images/quiz web design/Container/image 1.png", playTime:15, playAmount:5, questions:[]},
    {id:1, testName:"Thách thức sự hiểu biết của bạn", categoryId:1, image:"/assets/images/quiz web design/Container/image 1.png", playTime:15, playAmount:5, questions:[]},
    {id:1, testName:"Thách thức sự hiểu biết của bạn", categoryId:1, image:"/assets/images/quiz web design/Container/image 1.png", playTime:15, playAmount:5, questions:[]},
